        ...
        >
            ...
            >
                ...
                <div className="flex-grow p-6 overflow-y-auto text-neutral-700 dark:text-neutral-300 text-base leading-relaxed space-y-2">
                    <p>Welcome to RadioHost.cloud Studio, a modern, AI-powered web application for internet radio automation. This guide will walk you through its powerful features.</p>
                    ...
                    <ul className="list-disc list-inside space-y-1 pl-4">
                        ...
                        <li><strong>Tags:</strong> Right-click any track or folder to "Edit Tags". Tags help you categorize music for the AI Playlist Generator and Auto-Fill. Editing tags on a folder applies the changes to all its contents.</li>
                    ...
                    <SubTitle>AI Playlist &amp; Assistant</SubTitle>
                    <ul className="list-disc list-inside space-y-1 pl-4">
                        <li><strong>AI Playlist:</strong> Let Gemini create a playlist for you based on duration, mood (tags), and whether to include jingles.</li>
                        <li><strong>AI Assistant:</strong> Get interesting facts about the currently playing song to share with your listeners.</li>
                    </ul>
                    ...
                    <SectionTitle>7. Data & PWA</SectionTitle>
                    ...
                    <SectionTitle>8. Contact & Support</SectionTitle>
