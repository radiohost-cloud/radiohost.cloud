    ...
    return (
        <div className="px-4 pb-4 space-y-6 text-black dark:text-white">
            ...
            {isHostMode && (
                <>
                    <div>
                        <h2 className="text-xl font-semibold">Playout Mode</h2>
                        <p className="text-sm text-neutral-500 dark:text-neutral-400 mt-1">
                            Choose your role for this session. Changes will apply after a refresh.
                        </p>
                        <div className="mt-4">
                            <select
                                value={policy.playoutMode}
                                onChange={(e) => handlePolicyChange('playoutMode', e.target.value)}
