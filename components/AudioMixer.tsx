...
const AudioMixer: React.FC<AudioMixerProps> = ({ mixerConfig, onMixerChange, policy, onUpdatePolicy, audioLevels }) => {
                        ...
                        <div key={sourceId} className="p-3 bg-neutral-200/50 dark:bg-neutral-800/50 rounded-lg">
                            <div className="flex items-center justify-between mb-2">
                                <div className="flex items-center gap-2 text-sm font-medium text-black dark:text-white">
                                    ...
                                    <span>{SOURCE_META[sourceId as AudioSourceId]?.name || sourceId.replace('remote_', '')}</span>
