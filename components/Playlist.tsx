...
const Playlist: React.FC<PlaylistProps> = ({ items, currentPlayingItemId, currentTrackIndex, onRemove, onReorder, onPlayTrack, onInsertTrack, onInsertTimeMarker, onUpdateTimeMarker, onInsertVoiceTrack, isPlaying, stopAfterTrackId, onSetStopAfterTrackId, trackProgress, onClearPlaylist, onPflTrack, pflTrackId, isPflPlaying, pflProgress, mediaLibrary, timeline, policy, isContributor }) => {
