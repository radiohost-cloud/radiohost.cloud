                         ...
                         <div className="flex-grow flex flex-col min-h-0">
                            ...
                            <div className="flex-grow relative">
                                <div className="absolute inset-0 overflow-y-auto">
                                    ...
                                    {isStudio && activeRightColumnTab === 'mixer' && <AudioMixer mixerConfig={mixerConfig} onMixerChange={setMixerConfig} policy={playoutPolicy} onUpdatePolicy={setPlayoutPolicy} audioLevels={{}} />}
